    ...
    return PopScope(
      ...
      child: Scaffold(
          ...
          leading: Padding(
            ...
            child: Row(
              ...
              children: [
                IconButton(
                  onPressed: () {
                    var newDate = _homeController.changeDate(false);

                    _homeController.getTaskList(newDate);
                  },
                  icon: Padding(
                      ...
                      onTap: () async {
                        ...
                        if (pickedDate != null) {
                          ...
                          await _homeController
                              .getTaskList(_homeController.baseDate.value);
                        } else {}
                      },
                      child: Padding(
                        padding:
                ...
                IconButton(
                  onPressed: () {
                    var newDate = _homeController.changeDate(true);
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Obx(
                  () {
                    return _homeController.isRefreshing.value
                        ? Center(
                            child: Container(),
                          )
                        : _homeController.isTaskEmpty.value
                            ? SizedBox(
                                height:
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Text(
                                      "Add a task using the Add button below",
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontWeight: FontWeight.bold,
                                      ),
        ...
        floatingActionButton: FloatingActionButton(
          backgroundColor: const Color.fromARGB(255, 61, 114, 238),
          onPressed: () {
